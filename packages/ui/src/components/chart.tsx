...
type TooltipItemProps = {
  ...
  formatter?: RechartsPrimitive.DefaultTooltipContentProps<ValueType, NameType>["formatter"];
  color?: string;
  nestLabel: boolean;
...
function ItemContent({ itemConfig, item, nestLabel, tooltipLabel }: ItemContentProps) {
  return (
    <div
      className={cn(
