  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        [
          ...
          "outline-none hover:bg-foreground/10 focus:bg-foreground/10 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <CaretDownIcon className="size-4 transition-colors" weight="bold" />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          [
            "relative z-50 overflow-y-auto overflow-x-hidden rounded-md border bg-popover text-popover-foreground drop-shadow-xl/5",
