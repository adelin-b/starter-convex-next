...
/**
 * Cached version of usePaginatedQuery from convex-helpers.
 * Subscriptions stay active longer for faster reloading during navigation.
 *
 * @example
 * ```tsx
 ...
 * );
 *
 * // status can be: "CanLoadMore" | "LoadingMore" | "Exhausted" | "LoadingFirstPage"
 * ```
 */
