...
function NewAgentPage() {
  ...
  const onSubmit = async (values: AgentFormValues) => {
    ...
    // userId is guaranteed to exist due to AuthWrapper in layout
    if (!userId) {
      console.error("User ID missing - this should never happen due to AuthWrapper");
      return;
    }
          ...
          <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="rounded-lg border p-6">
              ...
              <div className="space-y-2">
                {selectedTemplate.dataSchema.fields.map((field, index) => (
