...
description: Use this agent to review TypeScript type safety patterns in StarterSaaS code. Detects missing assertNever in switches, arrays without `as const`, manual unions that should be derived, and missing type guards. Run after writing code with union types, switch statements, or literal arrays.
model: sonnet
color: blue
---
