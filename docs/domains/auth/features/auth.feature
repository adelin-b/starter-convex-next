...
Feature: User Authentication
	...
	Scenario: View sign up form on login page
	...
	Scenario: View sign in form on login page
		Given I am on the login page
	...
	Scenario: Successful sign up redirects to app
		When I sign up with name "Dashboard User", email "dashboard@example.com" and password "DashPass123"
		Then I should be logged in

	Scenario: Login page shows auth form to unauthenticated user
		Given I am on the login page
		Then I should see the sign in option
